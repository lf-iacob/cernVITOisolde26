...
PICOSCOPE -- Study of the beta amplitude and charge spectrum for different radioactive sources
             (@different trigger levels, @different scintillator configurations).
